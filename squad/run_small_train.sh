...
python3 train.py -n train-small-${1:-default_name} --train_record_file 'data/smaller_train.npz' --eval_steps 30 --dev_record_file 'data/smaller_dev.npz' --style="lsh" --num_epochs=5
